...
class NeedlePlotTestCase(TestCase):
    ...
    def _sample(self, ale, flask):
        ...
        return Sample.objects.create(
            population=ale_row, time_point=flask, name="1-1", is_clonal=True,
...
class NeedlePlotAxisTestCase(TestCase):
    ...
    def test_the_length_comes_from_the_stored_reference(self):
        ...
        reference = ReferenceSequences.objects.get(experiment=self.experiment)
    ...
    def test_a_new_call_is_visible_with_nothing_rebuilt(self):
        ...
        MutationCall.objects.create(
            mutation=Mutation.objects.create(
                ...
                gene="thrA", protein_change="", annotation={}, supplemental_data=Mutation.genome_diff_container({})),
